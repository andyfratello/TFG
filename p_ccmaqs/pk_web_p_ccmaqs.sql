  ...
  BEGIN
    ...
    FOR c IN (SELECT *
               ...
               WHERE codigo_org_planta = p_codigo_org_planta
                 AND numero_simulacion = p_codigo_simulacion) LOOP
      mytable(mytable.count + 1) := pk_web_p_ccmaqs.r_of(c.codigo_org_planta, c.numero_simulacion, c.orden_de_fabricacion, c.secuencia, c.fase, c.linea, c.tipo, c.fecha_ini, c.fecha_fin, c.recurso,
                                                         c.desc_recurso, c.porc_completado);
    END LOOP;
