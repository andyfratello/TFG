...
BEGIN
  FOR c IN (SELECT c.orden_de_fabricacion, c.secuencia, c.codigo_articulo, c.recurso, c.desc_recurso, c.y, c.nexttask, c.nextrecurso, c.recurso_libra
...
FUNCTION actualizar_datos_tarea(p_empresa VARCHAR2, p_planta VARCHAR2, p_simulacion VARCHAR2, p_orden_de_fabricacion NUMBER, p_secuencia NUMBER, p_fecha_inicio VARCHAR2/*, p_cambio_recurso BOOLEAN,
                                 ...
                                 p_recalcular_al_mover BOOLEAN*/) RETURN VARCHAR2 IS
...
BEGIN
  ...
  pkpantallas.log(
    'PARAMETROS: v_fecha_inicio: ' || v_fecha_inicio
  );

  v_result := sch_carga_maquinas.calcula_fecha_fin(p_empresa, p_planta, p_simulacion, p_orden_de_fabricacion, p_secuencia, v_fecha_inicio, false, null, null,
                                       null, null, null, null, null, null, null, null, null, null, false);
  RETURN v_result;
END actualizar_datos_tarea;
  
-- mira si la simulación entrada por parámetro está en uso por otro usuario
